var Pong = function () {
    ...
    this.paddle2 = { x: cw - 10 - _.paddleWidth, y: ch / 2 - _.paddleHeight / 2, w: _.paddleWidth, h: _.paddleHeight };
    this.ball = { x: cw / 2, y: ch / 2, radius: _.ballRadius };
    ...
    this.draw = function (cc) {
        ...
        drawCircle(cc, _.ball.x, _.ball.y, _.ball.radius, ballColor);
    ...
    this.updateBallMovement = function () {
        ...
        let boundColl = outBound(_.ball.x, _.ball.y, _.ball.radius, _.ball.radius, 0, 0, cw, ch);
        if (boundColl) {
            if (boundColl == 'x') {
                _.ballXDir *= -1
                if (_.ballXDir < 0) {
